...
public class viewdangki extends JFrame {
	...
	public viewdangki() {
		...
		btnNewButton_signup.setBackground(new Color(255, 153, 0));
		btnNewButton_signup.setForeground(new Color(255, 255, 255));
		...
		btnNewButton_cancel.setBackground(new Color(255, 153, 0));
