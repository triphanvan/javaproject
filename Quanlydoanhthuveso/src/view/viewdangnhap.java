...
public class viewdangnhap extends JFrame {
	...
	public viewdangnhap() {
		...
		lblNewLabel.setBounds(115, 11, 152, 22);
		...
		jlabel_username.setForeground(new Color(0, 0, 0));
		...
		lblNewLabel_password.setForeground(new Color(0, 0, 0));
		...
		textField_password.setColumns(10);
		 ...
		 chckbxNewCheckBox_remmemberme.setForeground(new Color(0, 0, 0));
		 chckbxNewCheckBox_remmemberme.setBackground(new Color(175, 238, 238));
		...
		contentPane.add(chckbxNewCheckBox_remmemberme);
		 ...
		 btnNewButton_login.setBackground(new Color(255, 153, 0));
		...
		contentPane.add(btnNewButton_login);
		 ...
		 btnNewButton_reset.setBackground(new Color(255, 153, 0));
		 btnNewButton_reset.setForeground(new Color(255, 255, 255));
		...
		btnNewButton_register.setBackground(new Color(255, 153, 0));
		btnNewButton_register.setForeground(new Color(255, 255, 255));
